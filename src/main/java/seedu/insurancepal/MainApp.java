...
import seedu.insurancepal.commons.core.Config;
import seedu.insurancepal.commons.core.LogsCenter;
import seedu.insurancepal.commons.core.Version;
import seedu.insurancepal.commons.exceptions.DataConversionException;
import seedu.insurancepal.commons.util.ConfigUtil;
...
import seedu.insurancepal.storage.InsurancePalStorage;
...
import seedu.insurancepal.storage.UserPrefsStorage;
import seedu.insurancepal.ui.Ui;
import seedu.insurancepal.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing InsurancePal ]===========================");
        super.init();
        ...
        InsurancePalStorage insurancePalStorage = new JsonInsurancePalStorage(userPrefs.getAddressBookFilePath());
        storage = new StorageManager(insurancePalStorage, userPrefsStorage);
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting InsurancePal " + MainApp.VERSION);
